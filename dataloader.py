...
def load_stsb_data(batch_size=32):
    ...
    # Convert to tensors
    train_emb1 = encoder.encode(dataset["train"]["sentence1"], convert_to_tensor="pt")
    train_emb2 = encoder.encode(dataset["train"]["sentence2"], convert_to_tensor="pt")
    ...
    test_emb1 = encoder.encode(dataset["validation"]["sentence1"], convert_to_tensor="pt")
    test_emb2 = encoder.encode(dataset["validation"]["sentence2"], convert_to_tensor="pt")
